...
layui.define(['laytpl', 'upload-mobile', 'layer-mobile', 'zepto'], function(exports){
  ...
  ,'<ul class="layui-unselect layui-layim-tab">'
    ...
    ,'<li title="通讯录" layim-event="tab" lay-type="friend"><i class="layui-icon">&#xe612;</i><span>通讯录</span><i class="layim-new" id="LAY_layimNewList"></i></li>'
    ,'<li title="发现" layim-event="tab" lay-type="more"><i class="layui-icon">&#xe670;</i><span>发现</span><i class="layim-new" id="LAY_layimNewMore"></i></li>'
  ,'</ul>'].join('');
  ...
  var anim = 'layui-anim-upbit', events = { 
    ...
    ,about: function(){
      layer.open({
        content: '<p style="padding-bottom: 5px;">用责任心做事</p><p>用感恩心做人</p><br><a href="/index/logout">退出登录</a>'
